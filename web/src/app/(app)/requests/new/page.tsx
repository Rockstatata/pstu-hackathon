...
export default function CreateRequestPage() {
  ...
  async function submit() {
    ...
    setError(null);
    try {
      await api.createMoneyRequest({ recipientUserId: recipient.userId, amountMinor, reason: reason.trim() });
